...
DECLARE
    ...
    names    namesarray;
BEGIN
    names := namesarray('Uczniowie', 'Klasy', 'Nauczyciele', 'Oceny', 'Przedmioty', 'Konkretne_przedmioty', 'Oceny_uczniow');
...
CREATE TABLE oceny_uczniow (
    ...
    ocena_id           NUMBER NOT NULL,
    wystawiajacy_id    NUMBER NOT NULL,
...
ALTER TABLE oceny_uczniow
    ADD CONSTRAINT nauczyciele_wystawiajacy_fk FOREIGN KEY ( wystawiajacy_id )
        REFERENCES nauczyciele ( nauczyciel_id );
