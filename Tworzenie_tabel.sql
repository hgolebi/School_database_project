...
DROP TABLE prowadzacy_przedmioty CASCADE CONSTRAINTS;
...
ALTER TABLE prowadzacy_przedmioty ADD CONSTRAINT prowadzacy_przedmioty_pk PRIMARY KEY ( konkretny_przedmiot_id );
...
ALTER TABLE prowadzacy_przedmioty
    ADD CONSTRAINT nauczyciele_fk FOREIGN KEY ( nauczyciel_id )
        REFERENCES nauczyciele ( nauczyciel_id );
...
ALTER TABLE prowadzacy_przedmioty
    ADD CONSTRAINT przedmioty_fk FOREIGN KEY ( przedmiot_id )
        REFERENCES przedmioty ( przedmiot_id );
